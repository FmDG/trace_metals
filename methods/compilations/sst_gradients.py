...
def show_sst_gradients(save_fig: bool = False, min_age: int = 2200, max_age: int = 3500):
    ...
    # ---------- SET PLOT ARGS ----------
    args_846 = {"color": colours[0], 'marker': '+', 'label': '846 (E Eq. Pacific)'}
    args_1012 = {"color": colours[1], 'marker': '+', 'label': '1012 (NE Pacific)'}
    args_1417 = {"color": colours[2], 'marker': '+', 'label': '1417 (Gulf of Alaska)'}
    ...
    ax.fill_between(sst_846.age_ka, sst_846.temp_min1, sst_846.temp_plus1, color=colours[0], alpha=0.1)
    ax.fill_between(sst_846.age_ka, sst_846.temp_min2, sst_846.temp_plus2, color=colours[0], alpha=0.1)

    # PLOT 1012
    ax.plot(sst_1012.age_ka, sst_1012.temp, **args_1012)
    ax.fill_between(sst_1012.age_ka, sst_1012.temp_min1, sst_1012.temp_plus1, color=colours[1], alpha=0.1)
    ax.fill_between(sst_1012.age_ka, sst_1012.temp_min2, sst_1012.temp_plus2, color=colours[1], alpha=0.1)

    # PLOT 1417
    ax.plot(sst_1417.age_ka, sst_1417.temp, **args_1417)
    ax.fill_between(sst_1417.age_ka, sst_1417.temp_min1, sst_1417.temp_plus1, color=colours[2], alpha=0.1)
    ax.fill_between(sst_1417.age_ka, sst_1417.temp_min2, sst_1417.temp_plus2, color=colours[2], alpha=0.1)
