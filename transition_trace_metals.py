...
axs[0].legend()
axs[0].set(xlim=[min_age, max_age], ylabel=r'$\delta^{13}$C')
...
axs[1].legend()
axs[1].set(xlim=[min_age, max_age], ylabel=r'$\delta^{18}$O')
axs[1].invert_yaxis()
...
axs[2].legend()
axs[2].set(xlim=[min_age, max_age], xlabel="Age (ka)", ylabel="Mg/Ca")
